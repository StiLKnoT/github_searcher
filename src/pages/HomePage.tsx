...
import {useLazyGetUserResponseQuery} from '../store/github/github.api'
  ...
  return (
    <div className='flex justify-center pt-10 mx-auto h-screen w-screen'>
      ...
      <div className='relative w-[560px]'>
        <input type="text" className='border py-2 px-4 w-full h-[42px] mb-2' placeholder='Search for Githbub username...'
        value={search}
